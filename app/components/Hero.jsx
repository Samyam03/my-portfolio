          ...
          <div className="order-2 lg:order-1 text-left">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-start mb-7">
              <button
                ...
                className="px-7 py-2 rounded-lg bg-blue-600 text-white font-semibold shadow-md border border-blue-700 hover:bg-blue-700 hover:shadow-lg transition-all duration-150 flex items-center space-x-2 text-base cursor-pointer"
              >
              ...
              <a
                ...
                className="px-7 py-2 rounded-lg bg-purple-600 text-white font-semibold shadow-md border border-purple-700 hover:bg-purple-700 hover:shadow-lg transition-all duration-150 flex items-center space-x-2 text-base cursor-pointer"
              >
