    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-28 pb-10 sm:pt-24 sm:pb-10">
      <div className="relative z-10 px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-20 items-start">
          ...
          <div className="order-1 lg:order-2 flex justify-center lg:justify-center mt-8 sm:mt-12">
            <div className="relative">
              {/* Profile image */}
              <div className="relative w-48 h-48 sm:w-56 sm:h-56 md:w-60 md:h-60 lg:w-80 lg:h-80 xl:w-96 xl:h-96 rounded-full overflow-hidden border-4 border-blue-500/30 shadow-2xl">
                <img
                  src="/myImage.jpg"
          ...
          <div className="order-2 lg:order-1">
                        {/* Greeting */}
            <div className="flex items-center space-x-2 mb-4 sm:mb-3 justify-start">
            ...
            <div className="text-center lg:text-left">
              {/* Name */}
              <h1 className="block text-5xl sm:text-6xl md:text-5xl lg:text-6xl xl:text-7xl font-bold text-white mb-4 sm:mb-6 leading-tight w-full">
                Samyam<br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-blue-600 text-5xl sm:text-6xl md:text-5xl lg:text-6xl xl:text-7xl font-bold w-full block">Bhattarai</span>
              </h1>

              {/* Title */}
              <div className="text-xl sm:text-2xl md:text-xl lg:text-2xl text-gray-300 mb-4 sm:mb-5 h-10 sm:h-12 min-h-[2.5rem] sm:min-h-[3rem]">
                <TypeAnimation
                  sequence={[
              ...
              {/* Description */}
              <p className="text-base sm:text-lg md:text-base lg:text-lg text-gray-300 mb-6 sm:mb-8 leading-relaxed max-w-lg mx-auto lg:mx-0">
                Crafting digital experiences with modern technologies. 
                Passionate about creating innovative solutions that make a difference in people's lives.
              </p>

              {/* CTA Buttons */}
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-5 justify-center lg:justify-start mb-6 sm:mb-8">
                <button
                  onClick={() => {
                ...
                >
                  ...
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 md:w-4 md:h-4 lg:w-5 lg:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="flex flex-row items-center justify-center gap-4 sm:gap-6 mt-6 sm:mt-8 mb-0">
                <a
